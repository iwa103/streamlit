...
def main():
    st.markdown("<h1 style='font-size:26px;'>避難所検索アプリ Ver 0.2（災害別絞込み対応：四国中央市向け）</h1>", unsafe_allow_html=True)

    # 🔽 Googleマップリンク付き「使い方」ブロック 🔽
    st.markdown(f"""
    <div style="font-size: 16px; line-height: 1.5; margin-bottom: 15px;">
        <p><strong>使い方:</strong></p>
        <ol style="padding-left: 20px;">
            <li>
                Googleマップで目的地点の緯度経度を取得してください。<br>
                👉 <a href="https://www.google.com/maps/" target="_blank">Googleマップを開く</a>
            </li>
            <li>取得した緯度経度をコピーして下の入力欄に貼り付けてください。</li>
            <li>対応災害・対応状況を選択すると、地図上に避難所が表示されます。</li>
        </ol>
    </div>
